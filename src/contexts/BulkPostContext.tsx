    ...
    const startBulkPost = useCallback(async (
        ...
        if (strategy === 'first-now') {
            ...
            for (let i = 0; i < slideshows.length; i++) {
                ...
                let batchStartTime = addMinutes(settings.startTime, batchIndex * (batchIntervalHours * 60));
        ...
        try {
            ...
            for (let i = 0; i < schedule.length; i++) {
                ...
                if (result.success) {
                    ...
                    if (strategy === 'batch' && postIntervalMinutes > 0) {
                        await new Promise(r => setTimeout(r, postIntervalMinutes * 60 * 1000));
                    }
                } else {
