...
import { Menu, X, LogOut, Folder, Home, ChevronRight, Sparkles } from "lucide-react";
...
function Header1({ path, onNavigateToFolder, onAction }: HeaderProps) {
    ...
    const { statusMessage, isPosting, isPaused, nextResumeTime } = useBulkPost();
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="hidden md:flex items-center space-x-2">
                                <Button
                                    ...
                                    className="bg-primary hover:bg-primary/90 text-white shadow-lg shadow-primary/20 border-0"
                                >
