...
import { UploadedImage, Folder, SlideshowMetadata, TextOverlay, SlideshowTemplate } from '../../types';
...
export const Dashboard: React.FC = () => {
  ...
  const [cutLength, setCutLength] = useState<number>(5);
      ...
      <div className="flex flex-col h-screen w-full bg-background text-foreground overflow-hidden">
        ...
        {showBulkCreateModal && (
          <BulkCreateFromTemplateModal
            ...
            onBulkCreate={async (templateId, options) => {
              try {
