...
const svgPaths = {
  ...
  pfa0d600:
    "M6.32 10C6.20799 10 6.15198 10 6.1092 9.9782C6.07157 9.95903 6.04097 9.92843 6.0218 9.8908C6 9.84802 6 9.79201 6 9.68V6.32C6.20799 6 6.15198 6 6.0218 6.1092C6.04097 6.07157 6.07157 6.04097 6.1092 6.0218C6.15198 6 6.20799 6 6.32 6L17.68 6C17.792 6 17.848 6 17.8908 6.0218C17.9284 6.04097 17.959 6.07157 17.9782 6.1092C18 6.15198 18 6.20799 18 6.32V9.68C18 9.79201 18 9.84802 17.9782 9.8908C17.959 9.92843 17.9284 9.95903 17.8908 9.9782C17.848 10 17.792 10 17.68 10H6.32Z"
};
/** ======================================================================= */
...
function getSidebarContent(activeSection: string): SidebarContent {
  ...
  return contentMap[activeSection] || contentMap.main;
}
...
export function DetailSidebar({
  ...
  content.sections[4].items[0].label = `Total Images: ${images.length}`;
  content.sections[4].items[1].label = `Selected: ${selectedImages.length}`;
  content.sections[4].items[2].label = `Slideshows: ${Math.floor(selectedImages.length / 3)}`;
...
function SubMenuItem({ item, onItemClick }: { item: MenuItemT; onItemClick?: (label: string) => void }) {
  return (
